...
> This is a fork of [zacheri04/TakeCtrl](https://github.com/zacheri04/TakeCtrl).
...
If macOS says the app is damaged, run this in Terminal before opening:

```bash
xattr -dr com.apple.quarantine /Applications/TakeCtrl.app
```
